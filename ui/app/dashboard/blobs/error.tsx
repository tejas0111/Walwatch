...
export default function BlobsError({
  error,
  reset,
}: {
  ...
  return (
    <div className="flex min-h-[50vh] items-center justify-center p-8">
      <div className="rounded-3xl border border-destructive/30 bg-destructive/5 px-8 py-12 text-center">
        ...
        <h1 className="mt-5 text-xl font-semibold text-destructive">Blobs error</h1>
        <p className="mx-auto mt-2 max-w-sm text-sm text-muted-foreground">
          Something went wrong loading blobs. Please try again.
        </p>
