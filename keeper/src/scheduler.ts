...
let _epochClient: SuiJsonRpcClient | null = null;

function getSuiJsonRpcClient(): SuiJsonRpcClient {
  if (!_epochClient) {
    _epochClient = new SuiJsonRpcClient({
...
async function getCurrentEpoch(): Promise<number> {
  const client = getSuiJsonRpcClient();
